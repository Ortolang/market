...
angular.module('ortolangMarketApp')
    .provider('i18n.fr', ['COMMON_FR', 'NAV_FR', 'BROWSER_FR', 'WORKSPACE_FR', 'PROCESSES_FR', 'TOOLS_FR',
        function (COMMON_FR, NAV_FR, BROWSER_FR, WORKSPACE_FR, PROCESSES_FR, TOOLS_FR) {
