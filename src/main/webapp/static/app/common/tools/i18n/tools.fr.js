    ...
    .constant('TOOLS_FR', {
        TOOLS: {
            ...
            DESCRIPTION: {
                ...
                LINK_LIST: 'Liste des fichiers générés à la suite de l\'exécution de l\'outil. Ils peuvent être sauvegardés dans un espace de travail ou téléchargés directement.'
            }
        }
    });
