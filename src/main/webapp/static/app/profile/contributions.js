...
angular.module('ortolangMarketApp')
    .controller('ContributionsCtrl', ['$scope', '$routeParams', 'ObjectResource', 'DownloadResource', 'N3Serializer', '$location',
        function ($scope, $routeParams, ObjectResource, DownloadResource, N3Serializer, $location) {
                                ...
                                if (oobject.object.metadatas.length > 0) {
                                    ...
                                    DownloadResource.download({oKey: metaKey}).success(function (metaContent) {
                                        N3Serializer.fromN3(metaContent).then(function (data) {
                                            if (data['http://www.ortolang.fr/ontology/developpers'] && data['http://www.ortolang.fr/ontology/developpers'].indexOf('Bertrand Gaiffe')) {
