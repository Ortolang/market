    ...
    .controller('ProfileCtrl', ['$scope', '$routeParams',
        function ($scope, $routeParams) {
            ...
            $scope.user = {
                ...
                'plus qu’à peine. Ses nombreuses pattes, lamentablement grêles par comparaison avec la corpulence qu’il avait par ailleurs, grouillaient désespérément sous ses yeux. <br/>' +
                '</p><blockquote><p>« Qu’est-ce qui m’est arrivé ? » pensa-t-il. <br/></p></blockquote><p> ' +
