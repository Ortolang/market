...
angular.module('ortolangMarketApp')
    .controller('ProfileCtrl', ['$scope', '$rootScope', '$routeParams', 'ProfileResource', 'User', 'GroupResource',
        function ($scope, $rootScope, $routeParams, ProfileResource, User, GroupResource) {
