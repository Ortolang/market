            ...
            link: {
                pre : function (scope) {
                    ...
                    if (scope.entry['meta_ortolang-item-json'].image) {
                        scope.image = Content.getContentUrlWithPath(scope.entry['meta_ortolang-item-json'].image, scope.entry['meta_ortolang-workspace-json'].wsalias, scope.entry['meta_ortolang-workspace-json'].snapshotName);
                    } else {
                        scope.imgtitle = '';
