...
angular.module('ortolangMarketApp')
    .controller('OrtolangItemJson15Ctrl', ['$scope', '$rootScope', '$translate', 'Settings', 'Content', 'Helper', 'ReferentialResource',
        function ($scope, $rootScope, $translate, Settings, Content, Helper, ReferentialResource) {
            ...
            function loadAdditionalInformations(lang) {
                ...
                loadFieldValuesInAdditionalInformations('terminoControlled', 'ITEM.TERMINO_CONTROLLED.LABEL', lang);
