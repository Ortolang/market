...
angular.module('ortolangMarketApp')
    .controller('OrtolangItemJson14Ctrl', ['$scope', '$rootScope', '$translate', 'Settings', 'Content', 'Helper',
        function ($scope, $rootScope, $translate, Settings, Content, Helper) {
            ...
            function loadAdditionalInformations(lang) {
                ...
                Helper.loadFieldValuesInAdditionalInformations($scope.content, $scope.additionalInformations, 'terminoControlled', 'ITEM.TERMINO_CONTROLED.LABEL', lang);
