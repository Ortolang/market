...
angular.module('ortolangMarketApp')
    .constant('WORKSPACE_EN', {
        WORKSPACE: {
            ...
            STATISTICS_DOWNLOADS_HELP: 'since October 2016',
            STATISTICS_DOWNLOADS_INFO: 'This functionality has been added in October 2016, therefore it does not include previous downloads.',
