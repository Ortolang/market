...
angular.module('ortolangMarketApp')
    .value('sample', function () {
        var rootCollectionKey = 'k1',
            ...
            profile = {givenName: 'John', familyName: 'Grant', email: 'john.grant@mock.com', emailHash: '389b1742a975233a2a248a01036fad5e', 'emailVisibility': 'EVERYBODY', 'emailVerified': false, 'status': 'ACTIVE', 'groups': ['moderators'], 'complete': true, 'friends': null, profileDatas: {'foo': 'bar'}, 'key': 'jgrant'},
