...
describe('Controller: ProcessesCtrl', function () {
    ...
    //it('should be possible to display the log of a process', function () {
    //    scope.showLog();
    //    expect(angular.element('.process-log ').length).toEqual(0);
    //    scope.showLog(sample().publishWorkspaceProcess);
    //    scope.$digest();
    //    expect(angular.element('.process-log ').length).toEqual(1);
    //});
